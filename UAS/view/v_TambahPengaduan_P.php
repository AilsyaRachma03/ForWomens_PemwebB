                ...
                <div class="container-fluid">
                  <form action="v_TambahPengaduan_P.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" name="jenis[]" value="Kekerasan" class=""> Kekerasan <br/>
                        <input type="checkbox" name="jenis[]" value="Diskriminasi" class=""> Kekerasan <br/>
                        <input type="checkbox" name="jenis[]" value="Pengucilan" class=""> Kekerasan <br/>
                    </div>
                    <div class="form-group">
