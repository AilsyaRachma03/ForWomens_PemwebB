        ...
        <a class="navbar-brand" href="#"> Send Message</a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li><a class="nav-link scrollto active" href="../view/v_LandingL.php">Home</a></li>
                    <li><a class="nav-link scrollto" href="../view/v_LandingL.php">About</a></li>
                    <li><a class="nav-link scrollto" href="../view/v_LandingL.php">Services</a></li>
