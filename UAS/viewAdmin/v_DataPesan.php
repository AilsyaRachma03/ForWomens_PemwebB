                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" >
                        <div class="card-header py-3" id="kolom">
                            <h6 class="m-0 font-weight-bold text-dark" >Data Pesan</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                    ...
                                    $no = $limit_start + 1;
                                    $query_mysql = mysqli_query($con, "SELECT * FROM pesan LIMIT $limit_start, $limit");
                                    ...
                                    ?>
                                        ...
                                        <td><?php echo $data['isipesan']; ?></td>

                                        <td>
                                          <a class="btn" href="../controller/c_hapusPesan.php?id=<?php echo $data['id']; ?>">Hapus</a>
                                        </td>
                                        </tr>
                                        <?php
                                        }
